...
func _on_back_pressed() -> void:
	preload("res://scenes/battle/runtime/BattleSceneRuntimeHelp.gd").on_back_pressed(self)

func _on_zeus_help_pressed() -> void:
	preload("res://scenes/battle/runtime/BattleSceneRuntimeHelp.gd").on_zeus_help_pressed(self)

func _on_opponent_hand_pressed() -> void:
	preload("res://scenes/battle/runtime/BattleSceneRuntimeHelp.gd").on_opponent_hand_pressed(self)
