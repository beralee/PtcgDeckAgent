...
const AuthorStrategyLivePromptSourceScript := preload("res://scripts/ai/ptcgdap/host/godot/AuthorStrategyLivePromptSource.gd")
const AuthorStrategyLiveSeamScript := preload("res://scripts/ai/ptcgdap/host/godot/PtcgDAPAuthorLiveSeam.gd")
const AuthorStrategySourceDocumentsScript := preload("res://scripts/ai/ptcgdap/host/godot/AuthorStrategySourceDocuments.gd")
...
const AuthorStrategyMatchEvidenceScript := preload("res://scripts/ui/battle/author_strategy/AuthorStrategyMatchEvidence.gd")
const AuthorStrategyDeveloperDecisionTraceScript := preload(
	"res://scripts/ui/battle/author_strategy/AuthorStrategyDeveloperDecisionTrace.gd"
)
const AuthorStrategyPublicReplayCoordinatorScript := preload(
	"res://scripts/ui/battle/author_strategy/AuthorStrategyPublicReplayCoordinator.gd"
)
const AuthorStrategyRecordingProfileScript := preload(
	"res://scripts/ui/battle/author_strategy/AuthorStrategyRecordingProfile.gd"
)
const BattleLivePacingProfileScript := preload(
	"res://scripts/ui/battle/performance/BattleLivePacingProfile.gd"
)
...
const UiInteractionWatchdogScript := preload("res://scripts/ui/interactions/UiInteractionWatchdog.gd")
...
const DeckTrainingCatalogScript := preload("res://scripts/training/DeckTrainingCatalog.gd")
const DeckTrainingStateFactoryScript := preload("res://scripts/training/DeckTrainingStateFactory.gd")
const DeckTrainingAdmissionVerifierScript := preload("res://scripts/training/DeckTrainingAdmissionVerifier.gd")
const DeckTrainingBattleControllerScript := preload("res://scripts/training/DeckTrainingBattleController.gd")
...
const PRIZE_TOUCH_MOVE_TOLERANCE := 32.0
...
const MODAL_ORIGIN_SLOT_ECHO_SUPPRESS_MSEC := 260
const MODAL_ORIGIN_SLOT_ECHO_POSITION_EPSILON := 28.0
const FIELD_ASSIGNMENT_SOURCE_FOLLOWUP_CHOICE_SUPPRESS_MSEC := 260
const MODAL_HAND_RELEASE_FALLBACK_WINDOW_MSEC := 1400
const HANDOVER_ATTACK_VFX_RECHECK_SECONDS := 0.05
...
const MODAL_POINTER_DRAIN_SHIELD_Z_INDEX := 1000
...
var _slot_mouse_action_press_active: bool = false
var _slot_mouse_action_press_slot_id: String = ""
var _slot_mouse_action_press_start: Vector2 = Vector2.ZERO
var _slot_mouse_action_press_consumed: bool = false
...
var _dialog_confirm_activated_on_button_down: bool = false
var _dialog_cancel_activated_on_button_down: bool = false
...
var _field_assignment_source_followup_choice_until_msec: int = 0
var _field_assignment_source_followup_choice_index: int = -1
...
var _hand_drag_suppress_origin_position: Vector2 = Vector2(-1.0, -1.0)
var _hand_drag_suppress_pointer_kind: String = ""
...
var _handover_attack_vfx_delay_active: bool = false
var _handover_attack_vfx_delay_token: int = 0
var _handover_attack_vfx_delay_timer: Variant = null
var _pending_attack_vfx_completion_action: Callable = Callable()
var _pending_attack_vfx_completion_reason: String = ""
var _opp_prize_slots: Array[BattleCardView] = []
var _my_prize_slots: Array[BattleCardView] = []
var _prize_prompt_generation: int = 0
var _prize_touch_press_contexts: Dictionary = {}
...
var _ui_interaction_sessions: UiInteractionSessionRegistry = UiInteractionSessionRegistryScript.new()
var _ui_interaction_watchdog: UiInteractionWatchdog = null
...
var _author_player_owner: Variant = null
var _development_player_rules_owner: Variant = null
var _author_development_ui_match_active: bool = false
var _author_runtime_start_error_code: String = ""
var _author_match_evidence: Variant = null
var _author_match_quick_review_context: Dictionary = {}
var _author_match_evidence_audit: Dictionary = {}
var _author_developer_decision_trace: Variant = null
var _author_developer_decision_trace_audit: Dictionary = {}
var _author_public_replay_coordinator: Variant = null
var _author_public_replay_audit: Dictionary = {}
var _author_recording_profile: Dictionary = {}
var _author_live_pacing_profile: Dictionary = {}
var _author_decision_owner: Variant = null
var _author_live_seam: Variant = null
var _author_serial_registry: Variant = null
var _author_source_documents: Variant = null
var _author_live_decision_generation: int = 1
var _author_live_canary_scheduled: bool = false
var _author_live_canary_running: bool = false
var _author_live_last_witness: Dictionary = {}
var _author_live_last_error_code: String = ""
...
var _author_policy_polling: bool = false
var _author_policy_wait_generation: int = 0
var _author_strategy_author_name: String = ""
var _author_strategy_deck_label: String = ""
...
var _replay_timeline: Array[Dictionary] = []
var _replay_current_frame_index: int = -1
var _replay_is_playing: bool = false
var _replay_playback_speed: float = 2.0
var _replay_playback_accumulator: float = 0.0
var _replay_preserve_visual_sequence_during_refresh: bool = false
var _replay_player_labels: Array[String] = []
var _replay_global_display_context_captured: bool = false
var _replay_previous_selected_deck_ids: Array[int] = []
var _replay_previous_player_display_names: Array[String] = []
...
var _match_end_tournament_return_pending: bool = false
...
var _match_end_return_navigation_started: bool = false
...
var _battle_ready_vfx_controller: RefCounted = BattleReadyVfxControllerScript.new()
var _battle_ready_vfx_registry: RefCounted = BattleReadyVfxRegistryScript.new()
var _battle_ready_vfx_evaluator: RefCounted = BattleReadyVfxEvaluatorScript.new()
...
var _battle_field_swap_animator: RefCounted = BattleFieldSwapAnimatorScript.new()
...
var _battle_visual_sequence_controller: RefCounted = BattleVisualSequenceControllerScript.new()
var _battle_action_intent_controller: RefCounted = BattleActionIntentControllerScript.new()
...
var _battle_action_log_presenter: RefCounted = BattleActionLogPresenterScript.new()
var _battle_log_rich_text_renderer: RefCounted = BattleLogRichTextRendererScript.new()
var _field_swap_overlay: Control = null
var _field_swap_last_snapshot: Dictionary = {}
...
@onready var _btn_replay_play_pause: Button = %BtnReplayPlayPause
@onready var _opt_replay_speed: OptionButton = %OptReplaySpeed
...
var _discard_collection_current_kind: String = ""
var _discard_collection_current_player_index: int = -1
var _discard_collection_current_title: String = ""
@warning_ignore_restore("unused_private_class_variable")
