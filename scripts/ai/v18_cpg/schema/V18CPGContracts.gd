...
const REGISTERED_FACT_PATHS: Array[String] = [
	...
	"board.bench_full",
	"board.bench_overflow_count",
	"board.bench_overflow_if_default",
	"board.bench_capacity_above_default",
	"board.bench_capacity_below_default",
	"board.opponent_bench_count",
	"board.opponent_bench_capacity",
	"board.opponent_bench_slots_free",
	"board.opponent_bench_full",
