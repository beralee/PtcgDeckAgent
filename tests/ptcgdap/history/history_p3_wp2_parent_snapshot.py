...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p3_wp2/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
EXPECTED_MANIFEST_RAW = "99EE7EB4FD962E3E5D1A200A33ABB545204369E6E6B0621EF2B5C648FAFEB8F2"
EXPECTED_MANIFEST_CANONICAL = "5B905779C2BAE7ADBF46EC300F3A8C54E7C307AB9E765F62E9344C87BEE2587A"
EXPECTED_PARENT_MANIFEST_RAW = "E0FD12EEE352976D930EE46685F937B0E0264EA567CBEB5FDF151372E57FE619"
EXPECTED_PARENT_MANIFEST_CANONICAL = "B47E808277C954003494A5C414E02AD6FA81C0CE6EC73A1E7064B40E991B2F4F"
EXPECTED_PARENT_DIGEST = "B82FEA95751BB4B54C52A0C8F9136A73FFD96CB0243228698FDFA6CEF5B482D3"
EXPECTED_COUNTS = {"untracked": 341, "deleted": 28, "modified": 1}
P3_WP2_PATHS = {
...
class P3Wp2ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_and_complete(self) -> None:
        self.assertEqual(self.manifest["work_package"], "P3-WP2")
        self.assertEqual(self.manifest["file_count"], 16)
        ...
        self.assertEqual(set(self.manifest["rollback_scope"]["delete_exact_paths"]), P3_WP2_PATHS)
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p3-wp2-parent-") as temp:
            root = Path(temp)
    ...
    def test_virtual_rollback_reproduces_p3_wp1_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p3_wp6/") or path in P3_WP6_PATHS or path.startswith("artifacts/ptcgdap/p3_wp7/") or path in P3_WP7_PATHS or path.startswith("artifacts/ptcgdap/p3_wp8/") or path in P3_WP8_PATHS or path.startswith("artifacts/ptcgdap/p4_wp1/") or path in P4_WP1_PATHS or path.startswith("artifacts/ptcgdap/p4_wp2/") or path in P4_WP2_PATHS or path.startswith("artifacts/ptcgdap/p4_wp3/") or path in P4_WP3_PATHS or path.startswith("artifacts/ptcgdap/p4_wp4/") or path in P4_WP4_PATHS or path.startswith("artifacts/ptcgdap/p4_wp5/") or path in P4_WP5_PATHS or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in P4_WP6_PATHS:
                continue
            if (
                path.startswith("artifacts/ptcgdap/p3_wp1/")
                or path.startswith("artifacts/ptcgdap/p3_wp2/")
                or path in P3_WP2_PATHS
        ...
        self.assertEqual(len(records), 370)
