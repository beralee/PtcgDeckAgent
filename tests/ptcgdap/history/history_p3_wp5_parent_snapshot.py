...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p3_wp5/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
EXPECTED_MANIFEST_RAW = "64470411EC6EDED2D4821A09C648723EE94F4F548445FA57D918F71C62667560"
EXPECTED_MANIFEST_CANONICAL = "BBE449A7C118DABC7417E452A6E742C970CF07E48FF536363E2AF4951B5B4CEF"
EXPECTED_PARENT_MANIFEST_RAW = "5321F57EBF81AEFE1D042730AC05B93CDCEC3052A94CC469EA5BFDEE40719FAF"
EXPECTED_PARENT_MANIFEST_CANONICAL = "055ABF3E759069C6DC52FC760C81F9041A32EF3FC14B80A958E69174D0287643"
EXPECTED_PARENT_DIGEST = "F338695685482CF2ED90BE115690F5DB5CA6F826B8E19222B822D014F7BFF239"
EXPECTED_COUNTS = {"untracked": 465, "deleted": 28, "modified": 1}
P3_WP5_PATHS = {
    "contracts/ptcgdap/shadow_prompt_broker.schema.json",
    "contracts/ptcgdap/shadow_prompt_broker_profile.json",
    "contracts/ptcgdap/shadow_prompt_broker_conformance_vectors.json",
    "contracts/ptcgdap/shadow_prompt_broker_bundle.json",
    "scripts/ai/ptcgdap/shadow_prompt_broker.py",
    "scripts/engine/decision/ShadowPromptBroker.gd",
    "tools/ptcgdap/build_shadow_prompt_broker_contract.py",
    "tests/ptcgdap/test_shadow_prompt_broker_contract_builder.py",
    "tests/ptcgdap/test_shadow_prompt_broker.py",
    "tests/ptcgdap/test_shadow_prompt_broker_properties.py",
    "tests/ptcgdap/test_p3_wp5_boundaries.py",
    "tests/ptcgdap/test_p3_wp5_parent_snapshot.py",
...
class P3Wp5ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_and_complete(self) -> None:
        self.assertEqual(self.manifest["file_count"], 23)
        ...
        self.assertEqual(set(self.manifest["rollback_scope"]["delete_exact_paths"]), P3_WP5_PATHS)
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p3-wp5-parent-") as temp:
            root = Path(temp)
    ...
    def test_virtual_rollback_reproduces_p3_wp4_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p3_wp6/") or path in P3_WP6_PATHS or path.startswith("artifacts/ptcgdap/p3_wp7/") or path in P3_WP7_PATHS or path.startswith("artifacts/ptcgdap/p3_wp8/") or path in P3_WP8_PATHS or path.startswith("artifacts/ptcgdap/p4_wp1/") or path in P4_WP1_PATHS or path.startswith("artifacts/ptcgdap/p4_wp2/") or path in P4_WP2_PATHS or path.startswith("artifacts/ptcgdap/p4_wp3/") or path in P4_WP3_PATHS or path.startswith("artifacts/ptcgdap/p4_wp4/") or path in P4_WP4_PATHS or path.startswith("artifacts/ptcgdap/p4_wp5/") or path in P4_WP5_PATHS or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in P4_WP6_PATHS:
                continue
            if path.startswith("artifacts/ptcgdap/p3_wp4/") or path.startswith("artifacts/ptcgdap/p3_wp5/") or path in P3_WP5_PATHS:
                continue
        ...
        self.assertEqual(len(records), 494)
