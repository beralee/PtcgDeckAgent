...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p4_wp6/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
PARENT_MANIFEST_PATH = ROOT / "artifacts/ptcgdap/p4_wp5/manifest.json"
EXPECTED_MANIFEST_RAW = "6C8E7FE2423BAE2F20A1EE3E3D2973C3B7122132F8A618D094897CBFCCA007B0"
EXPECTED_MANIFEST_CANONICAL = "DBC00E8CCCFAF81579E164E221A47555D55B3D2F68AE1D8DA2FA544B98809F34"
EXPECTED_PARENT_MANIFEST_RAW = "B93FBCD2F3DF67692B6D2CD9F6F7FED99002783672A9C7055DF6AD3BBB368E2B"
EXPECTED_PARENT_MANIFEST_CANONICAL = "E013989E65D3148EDAFA50045BB6C3E25AA79E1B14217DBCF2D76BB9BCB1CD71"
EXPECTED_PARENT_DIGEST = "4B5084606B5CDAC87981A972484446470F993E8506FBC6B38487DA994906C6A2"
EXPECTED_COUNTS = {"untracked": 905, "deleted": 28, "modified": 1}
...
class P4Wp6ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_complete_and_bind_parent(self) -> None:
        self.assertEqual(34, self.manifest["file_count"])
        self.assertEqual(34, len(self.entries))
        ...
        self.assertEqual("artifacts/ptcgdap/p4_wp6/", scope["delete_evidence_prefix"])
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p4-wp6-parent-") as temp:
    ...
    def test_virtual_rollback_reproduces_p4_wp5_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p4_wp5/") or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in delete_paths:
                continue
        ...
        self.assertEqual(934, len(records))
