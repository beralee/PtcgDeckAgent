...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p5_wp1/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
PARENT_MANIFEST_PATH = ROOT / "artifacts/ptcgdap/p4_wp6/manifest.json"
...
EXPECTED_PARENT_MANIFEST_RAW = "95FEAAC3956C3CBDC72EF68AEF8289A60F65F5FDDA7FD0038BC86374B607FE39"
EXPECTED_PARENT_MANIFEST_CANONICAL = "93B0F8170124AE5DD184FBD1BD17BBEC60C805A6EFC9D348C1B5ADAF5AD3369E"
EXPECTED_PARENT_DIGEST = "1498B6325AF2795226B2F0F78E3740198BE43DCAB7A9839AD7D8BAC80B1EA512"
EXPECTED_COUNTS = {"untracked": 965, "deleted": 28, "modified": 1}
EXPECTED_MANIFEST_RAW = "BBA9BA9E3B87C0CBB96CC0F15E1287D669497A41F0DF623A187AAD9752FCB113"
EXPECTED_MANIFEST_CANONICAL = "83103923727EB1E002B888369306AEEC00C9DEE40A8493E6E1BFCDA42DDAD936"
...
class P5Wp1ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_complete_and_bind_parent(self) -> None:
        self.assertEqual(36, self.manifest["file_count"])
        self.assertEqual(36, len(self.entries))
        ...
        self.assertEqual(21, len(set(scope["delete_exact_paths"])))
        self.assertEqual("artifacts/ptcgdap/p5_wp1/", scope["delete_evidence_prefix"])
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p5-wp1-parent-") as temp:
    ...
    def test_virtual_rollback_reproduces_p4_wp6_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p4_wp6/") or path.startswith("artifacts/ptcgdap/p5_wp1/") or path.startswith("artifacts/ptcgdap/p5_wp2/") or path in delete_paths or path in P5_WP2_PATHS or is_p5_wp3_path(path):
                continue
        ...
        self.assertEqual(994, len(records))
