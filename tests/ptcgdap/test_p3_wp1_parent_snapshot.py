...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p3_wp1/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
EXPECTED_MANIFEST_RAW = "A733BB84E39A544DB4E257BE8B121D193399381DCD5EDD3A23213F642A1E15DD"
EXPECTED_MANIFEST_CANONICAL = "2ED2D47E249296607BDC6E9CC9966C0E396F0FC87FD4F5A5B22F6DE672202A5F"
EXPECTED_PARENT_MANIFEST_RAW = "6F339E9B174717330DAD609215489A851C730AE6AC8007A9CA03D3D753961539"
EXPECTED_PARENT_MANIFEST_CANONICAL = "F0A2C3E92E566163F14FA4B49C33728637660BCF192D59CA32B2B578DBAFB816"
EXPECTED_PARENT_DIGEST = "DB77E9B337256D3A05755FACC4757CC1F9549AEC908479292339DCE0ECB09C6C"
EXPECTED_COUNTS = {"untracked": 299, "deleted": 28, "modified": 1}
P3_PATHS = {
    "contracts/ptcgdap/engine_decision_port.schema.json",
    "contracts/ptcgdap/engine_decision_port_profile.json",
    "contracts/ptcgdap/engine_decision_port_conformance_vectors.json",
    "contracts/ptcgdap/engine_decision_port_bundle.json",
    "scripts/ai/ptcgdap/engine_decision_port.py",
    "scripts/engine/decision/EngineDecisionPort.gd",
    "tools/ptcgdap/build_engine_decision_port_contract.py",
    "tests/ptcgdap/test_engine_decision_port_contract_builder.py",
    "tests/ptcgdap/test_engine_decision_port.py",
    "tests/ptcgdap/test_engine_decision_port_properties.py",
...
class P3Wp1ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_and_complete(self) -> None:
        self.assertEqual(self.manifest["work_package"], "P3-WP1")
        self.assertEqual(self.manifest["file_count"], 14)
        ...
        self.assertEqual(set(self.manifest["rollback_scope"]["delete_exact_paths"]), P3_PATHS)
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p3-wp1-parent-") as temp:
            root = Path(temp)
    ...
    def test_virtual_rollback_reproduces_p2_wp5_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p3_wp6/") or path in P3_WP6_PATHS or path.startswith("artifacts/ptcgdap/p3_wp7/") or path in P3_WP7_PATHS or path.startswith("artifacts/ptcgdap/p3_wp8/") or path in P3_WP8_PATHS or path.startswith("artifacts/ptcgdap/p4_wp1/") or path in P4_WP1_PATHS or path.startswith("artifacts/ptcgdap/p4_wp2/") or path in P4_WP2_PATHS or path.startswith("artifacts/ptcgdap/p4_wp3/") or path in P4_WP3_PATHS or path.startswith("artifacts/ptcgdap/p4_wp4/") or path in P4_WP4_PATHS or path.startswith("artifacts/ptcgdap/p4_wp5/") or path in P4_WP5_PATHS or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in P4_WP6_PATHS:
                continue
            if (
                path.startswith("artifacts/ptcgdap/p2_wp5/")
                or path.startswith("artifacts/ptcgdap/p3_wp1/")
                or path in P3_PATHS
            ...
            if path in FUTURE_P3_WP3_PARENT_BYTES:
                ...
                data = FUTURE_P3_WP3_PARENT_BYTES[path]
