...
from tests.ptcgdap.test_p3_wp7_parent_snapshot import P4_WP4_PATHS
...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p4_wp3/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
PARENT_MANIFEST_PATH = ROOT / "artifacts/ptcgdap/p4_wp2/manifest.json"
EXPECTED_MANIFEST_RAW = "A671528C03853BE97058F3C73026CF8F87FEB8F900A743E25D03A6808A37A4A1"
EXPECTED_MANIFEST_CANONICAL = "66574BA50DBF555E8607E416A5C1207F60CCEA40A0BE4CDDD308FB519360C2D2"
EXPECTED_PARENT_MANIFEST_RAW = "D801B6CA249DCBD073E8DA748E0F8F5BA33C7EE54B815528EA7F4AF64EFA6992"
EXPECTED_PARENT_MANIFEST_CANONICAL = "B87153325F0482C6BA1657331E5C03F92D4FC4B138FEE2A6EF402B6211EC5007"
EXPECTED_PARENT_DIGEST = "2A9993C330A953CE25A909AC4F6317EE8BECE8F84CB9AEC9012C5E7A291A79A7"
EXPECTED_COUNTS = {"untracked": 749, "deleted": 28, "modified": 1}
...
class P4Wp3ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_complete_and_bind_parent(self) -> None:
        self.assertEqual(27, self.manifest["file_count"])
        self.assertEqual(27, len(self.entries))
        ...
        self.assertEqual("artifacts/ptcgdap/p4_wp3/", scope["delete_evidence_prefix"])
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p4-wp3-parent-") as temp:
    ...
    def test_virtual_rollback_reproduces_p4_wp2_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p4_wp2/") or path.startswith("artifacts/ptcgdap/p4_wp3/") or path in delete_paths or path.startswith("artifacts/ptcgdap/p4_wp4/") or path in P4_WP4_PATHS or path.startswith("artifacts/ptcgdap/p4_wp5/") or path in P4_WP5_PATHS or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in P4_WP6_PATHS:
                continue
        ...
        self.assertEqual(778, len(records))
