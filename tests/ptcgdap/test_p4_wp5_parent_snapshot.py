...
from tests.ptcgdap.test_p3_wp7_parent_snapshot import P4_WP6_PATHS
...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p4_wp5/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
PARENT_MANIFEST_PATH = ROOT / "artifacts/ptcgdap/p4_wp4/manifest.json"
EXPECTED_MANIFEST_RAW = "C629E7EFCD2CAF86BD1603B7498C853E59DD8FC5DB62F9B5058C00F715AADA1B"
EXPECTED_MANIFEST_CANONICAL = "BD58BECFB8B84F73AF869E5790BA2E0375A8F00591C9667552946627CE113F3F"
EXPECTED_PARENT_MANIFEST_RAW = "7BEF12014634888BE94B24FC7D962020D2ADF1AC2DD4307FC2728A66C4BFF660"
EXPECTED_PARENT_MANIFEST_CANONICAL = "BFD5FE2CA361720973085E792C02EBA2382FA1CA1ABCC767D440FAE7C40D6380"
EXPECTED_PARENT_DIGEST = "BC65343A3F5D5616B119EF3C2A46A244738F4DCD8ABDE8A101CBCF043A602BC1"
EXPECTED_COUNTS = {"untracked": 851, "deleted": 28, "modified": 1}
...
class P4Wp5ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_complete_and_bind_parent(self) -> None:
        self.assertEqual(35, self.manifest["file_count"])
        self.assertEqual(35, len(self.entries))
        ...
        self.assertEqual("artifacts/ptcgdap/p4_wp5/", scope["delete_evidence_prefix"])
    ...
    def test_isolated_restore_contains_only_parent_files(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ptcgdap-p4-wp5-parent-") as temp:
    ...
    def test_virtual_rollback_reproduces_p4_wp4_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p4_wp4/") or path.startswith("artifacts/ptcgdap/p4_wp5/") or path in delete_paths or path.startswith("artifacts/ptcgdap/p4_wp6/") or path in P4_WP6_PATHS:
                continue
        ...
        self.assertEqual(880, len(records))
