...
SNAPSHOT_ROOT = ROOT / "artifacts/ptcgdap/p5_wp2/parent_snapshot"
MANIFEST_PATH = SNAPSHOT_ROOT / "manifest.json"
PARENT_MANIFEST_PATH = ROOT / "artifacts/ptcgdap/p5_wp1/manifest.json"
EXPECTED_PARENT_MANIFEST_RAW = "F87F642406C649425D248607B9F9B6AFEC9E3430D2184269B08B7F9A093FAD34"
EXPECTED_PARENT_MANIFEST_CANONICAL = "673E47F897028AC4BA322818047290BBE5D5FC28E304918F32A73410A520F944"
EXPECTED_PARENT_DIGEST = "DBAD04BD19379CBBAFCB4C0E6C27383EA8FAC74C96D49650C4CBDE65C16CB1EF"
EXPECTED_COUNTS = {"untracked": 1032, "deleted": 28, "modified": 1}
EXPECTED_MANIFEST_RAW = "6D598520278254FC15D2A2BB6FABE68151770DA3BBD2D128FAC9C3EC967BB192"
EXPECTED_MANIFEST_CANONICAL = "71E3346D252AB5AC829E3615EEB9CFCC64ADE362676C0392052E9A5D54AAEE4E"
...
class P5Wp2ParentSnapshotTests(unittest.TestCase):
    ...
    def test_payloads_are_exact_safe_complete_and_bind_parent(self) -> None:
        ...
        self.assertEqual("artifacts/ptcgdap/p5_wp2/", scope["delete_evidence_prefix"])
    ...
    def test_virtual_rollback_reproduces_p5_wp1_candidate(self) -> None:
        ...
        for code, path in status():
            if path.startswith("artifacts/ptcgdap/p5_wp1/") or path.startswith("artifacts/ptcgdap/p5_wp2/") or path in delete_paths or is_p5_wp3_path(path):
                continue
        ...
        self.assertEqual(1061, len(records))
